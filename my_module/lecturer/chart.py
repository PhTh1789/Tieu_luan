...
# xlsx_path,subject_list, option = get_subject(score_folder_path = score_data)
#         # gán biến tên môn
...
def get_chart():
    ...
    # chọn môn
    xlsx_path,subject_list, option = get_subject(score_folder_path)
    # gán biến tên môn
    subject = subject_list[option]
    # gọi ra tên của tất cả các lớp học có trong file
    class_sheet=pd.ExcelFile(xlsx_path).sheet_names
        ...
        ### 1 Đối tượng
            ...
            ## 2 học kỳ
                ...
                # gán biến lần lượt: data học kỳ số 1, data học kỳ số 2, tên học kỳ số 1, tên học kỳ số 2 được lấy ra từ hàm colum
                    ...
                    chosse = input("Chọn kiểu biểu đồ: \
                    ...
                    try:
                        ...
                        ## 2 học kỳ
                            if semester == "Cả hai":
                                ...
                                chosse = input("Ở lựa chọn này chỉ hỗ trợ vẽ 1 biểu đồ \
                                                \n Chọn:\
                                                \n(1) Scatter chart - Biểu đồ thể hiện sự phân bố\
                                                \n--> ")
                            # Scater 
